 ...
 *      {@link #createAccessToken(OAuth2Authentication)}
 *      {@link #getAccessToken(OAuth2Authentication)}
 *      {@link #refreshAccessToken(String, TokenRequest)}
 * 
 * 
 *      ResourceServerTokenServices {@link #loadAuthentication(String)}
 *      {@link #readAccessToken(String)}
 * 
 * 
 *      ConsumerTokenServices {@link #revokeToken(String)}
 * 
 * @see InitializingBean #afterPropertiesSet()
 * 
 * @ClassName: DtTokenServices
 * @Description:TODO(这里用一句话描述这个类的作用)
 * @author: tupengxiong tupengxiong@qq.com
 * @date: 2018年6月9日 下午9:02:44
 * @version V1.0
 */
//@Service("dtTokenServices")
public class DtTokenServices
		implements AuthorizationServerTokenServices, ResourceServerTokenServices, ConsumerTokenServices {
	
	private final static Log logger = LogFactory.getLog(DtTokenServices.class);
	...
	private int refreshTokenValiditySeconds = 60 * 60 * 2; // default 2 hours.
